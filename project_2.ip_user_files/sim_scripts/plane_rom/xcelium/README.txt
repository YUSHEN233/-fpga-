...
#
# Generated by export_simulation on Fri Jul 31 20:55:06 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './plane_rom.sh' script.

./plane_rom.sh -reset_run
...
./plane_rom.sh -noclean_files

For more information on the script, please type './plane_rom.sh -help'.
