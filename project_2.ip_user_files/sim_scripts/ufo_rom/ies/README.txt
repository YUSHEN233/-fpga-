...
#
# Generated by export_simulation on Fri Jul 31 20:56:43 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './ufo_rom.sh' script.

./ufo_rom.sh -reset_run
...
./ufo_rom.sh -noclean_files

For more information on the script, please type './ufo_rom.sh -help'.
