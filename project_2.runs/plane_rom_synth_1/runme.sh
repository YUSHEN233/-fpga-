...
HD_PWD='C:/Users/AREA184/Desktop/gameplane/project_2.runs/plane_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log plane_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source plane_rom.tcl
